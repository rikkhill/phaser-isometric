...
export default class DialogueOptionStack extends Phaser.GameObjects.Container {
  constructor(config) {
    ...
    this.continuation = this.scene.add.existing(new DialogueOption({
      ...
      text: "...",
      value: 0,
      style: {fontFamily: 'Gill Sans, sans-serif', fontSize: 26, color: '#aaffaa', fontStyle: ""},
      hoverStyle: {fontFamily: 'Gill Sans, sans-serif', fontSize: 26, color: '#448844', fontStyle: 'bold'},
